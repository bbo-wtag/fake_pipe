...
module FakePipe
  describe Mutator do
    context 'happy path' do
      ...
      context '#mutate_address_zipcode' do
        it 'matches proper format' do
          expect(described_class.mutate('address_zipcode', 'dont_care')).to match /[0-9]+/
        end
      end
      ...
      context '#mutate_vat_number' do
        it 'matches proper format' do
          expect(described_class.mutate('vat_number', 'dont_care')).to match /[0-9]+/
        end
      end
      ...
      context '#mutate_empty_curly' do
        it 'matches proper format' do
          expect(described_class.mutate('cell_phone', 'dont_care')).to match /[0-9()]+/
        end
      end
